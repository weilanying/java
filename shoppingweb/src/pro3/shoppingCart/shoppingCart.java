...
public class shoppingCart extends HttpServlet {
	public void doGet(HttpServletRequest req,
		...
		out.print("				<form>");
		out.print("					<input type='button' value='提交订单' size='1' onclick='javascript:window.location='orderConfirm';'>");
		out.print("					<input type='button' value='继续购物' size='2' onclick='javascript:window.location='../product/productList';'>");
		out.print("					<input type='button' value='清空购物车' size='2' onclick='javascript:window.location='../product/productList';'>");
		out.print("				</form>");
		out.print("				</td>");
		out.print("			</tr>");
		out.print("		</table>");
